...
SCRIPT_SCHEDULES = [
    {"time": '09:30', "script": "执行脚本/淘系_淘宝联盟/tb_tk_淘宝联盟_服务商合作_普通招商_我报名的活动_报名的商品_202509.py"},
    {"time": '09:31', "script": "执行脚本/淘系_淘宝联盟/tb_tk_淘宝联盟_数据分析_定向计划报表_分天明细_202509.py"},
    {"time": '09:32', "script": "执行脚本/淘系_淘宝联盟/tb_tk_淘宝联盟_商品分析_202504.py"},
    {"time": '09:33', "script": "执行脚本/淘系_淘宝联盟/tb_tk_淘宝联盟_数据分析_cps订单明细_订单结算明细报表_202505.py"},
    {"time": '09:34', "script": "执行脚本/淘系_万相台/tb_tg_万相台无界_基础报表_货品全站推_202504.py"},
    {"time": '09:35', "script": "执行脚本/淘系_生意参谋/tb_sycm_自助分析_取数_商品_流量来源_所有商品_格式化.py"}, # noqa
