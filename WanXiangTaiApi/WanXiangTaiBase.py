...
class WanXiangTaiBaseApi:
    ...
    def __init__(self, cookie):
        ...
        if self.csrfId and self.loginPointId:
            logger.success(f"WanXiangTaiBaseApi 初始化成功,csrfId:{self.csrfId},loginPointId:{self.loginPointId}")
        else:
            raise Exception("WanXiangTaiBaseApi初始化失败")
