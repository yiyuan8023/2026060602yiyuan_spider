...
if __name__ == '__main__':
    ...
    table_name = 'caiwu_上海康趣_微商城_202601'  # noqa

    list_file_path = list_file_path(r"C:\Users\admin\Desktop\20-25年品牌采购数据\微商城",  file_extension="xlsx")
    # list_file_path = [r'C:\Users\admin\Desktop\20-25年品牌采购数据\2020-2021年-美云销.xlsx']
