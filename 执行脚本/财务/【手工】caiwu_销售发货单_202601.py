...
if __name__ == '__main__':
    ...
    table_name = 'caiwu_销售发货单_202601'  # noqa
    shop_name = '林内优品'
    # list_file_path = list_file_path(r"C:\Users\admin\Desktop\财务20260119\销售出库", file_pattern="202*", file_extension="xlsx")
    list_file_path = [r'C:\Users\admin\Desktop\财务20260119\销售出库\2023-2025平台发货单.xlsx']
    ...
    for file_path in list_file_path:
        ...
        # DBManager(db_config=db_config).insert_delete_insert_data(filtered_items, table_name,)
