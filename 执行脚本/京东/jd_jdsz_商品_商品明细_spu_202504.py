...
if __name__ == '__main__':
    ...
    table_name = "jd_jdsz_商品_商品明细_spu_202504"
    site = '京东商智'
    ...
    for i in shop_cookies:
        ...
        for date in crawl_day_list:
            ...
            res = Obj.fetch_product_analysis__product_detail(date)
            gridData = res.get("content", {}).get("gridData", {}) # NOQA

            data = gridData.get("data", [])  # 索引对应的数据
            metaIndex = gridData.get("metaIndex", {})  # 英文标题对应的索引
