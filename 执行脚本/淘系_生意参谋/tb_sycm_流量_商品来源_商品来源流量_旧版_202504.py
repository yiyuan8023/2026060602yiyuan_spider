...
if __name__ == '__main__':
    ...
    site = '生意参谋'
    shop_cookies, crawl_day_list = select_shop_date(table_name, site, shop_name_list, 18)
    crawl_day_list= ['2026-01-01', '2026-01-02', '2026-01-03', '2026-01-04']
    shop_item_ids = {
        '林内热水器旗舰店': ["732897762742", "793864718809", "763629523250", "763629523250", "1003352210602"],
