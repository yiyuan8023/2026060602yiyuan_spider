...
if __name__ == '__main__':
    ...
    shops = [
        ...
        {"db_config": 'rinnai', "shop_name": "林内厨电旗舰店", "file_path": r"E:\1\ExportOrderList25954993239.xlsx"}, # noqa
        {"db_config": 'rinnai', "shop_name": "林内品牌折扣店", "file_path": r"E:\1\ExportOrderList25955497160.xlsx"}, # noqa
        {"db_config": 'rinnai', "shop_name": "智慧家电直销店", "file_path": r"E:\1\ExportOrderList25954921258.xlsx"}, # noqa
    ]
