...
if __name__ == '__main__':
    ...
    logger.info(f"\n{'*' * 120}")
    file_path_ = r'E:\1\ExportOrderList25723549259.xlsx'  # NOQA
    table_name = 'rinnai_tb_商家工作台_交易_已卖出宝贝_订单报表_202411'  # noqa
    shop_name = '林内官方旗舰店'
    ...
    DBManager(db_config=db_config).update_insert_date(items_, table_name, primary_key='订单编号')
