...
if __name__ == '__main__':
    ...
    db_table_name = "pdd_数据中心_服务数据_售后数据"
    site = '拼多多'
    shop_cookies, crawl_day_list = data_collector(db_table_name, site, shop_name_list, 3)
    ...
    for i in shop_cookies:
        ...
        for date in crawl_day_list:
            ...
            res = Obj.service_data__after_sales_data(date)
            sleep(3)
        # task_id = '10568864'
