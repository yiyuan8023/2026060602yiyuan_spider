# -*- coding: utf-8 -*-
# @Time : 2024/7/source_map_4 16:32
# @Author : Shao0000
# @Email : Michael_Shao0000@aliyun.com
# @File : log_.py
# @Project : ShengYiCanMou
import sys
...
from settings_pass import LOGFILE
...
class Logger:
    ...
    def logger_add(self):
        if LOGFILE:
            ...
            loguru.logger.add(sink=sys.stdout,format="{time:YYYY-MM-DD HH:mm:ss} | {level} | {file}:{line} : {message}")
