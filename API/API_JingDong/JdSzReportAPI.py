...
class JdSzReportAPI(JdSzAPI):
    ...
    def fetch_report_analysis__my_report(self):
        """
    ...
    def fetch_report_analysis__my_report__excel(self, startDate, endDate):
        """
       报表分析》》我的报表》》新建报表>>维度：店铺
                                   汇总周期：自然天
                                   查询日期：自定义
       ...
       """
        ...
        Indicators = [{"text": "老客户数", "value": "OldUserNum", "selected": True, "index": 1},
                      {"text": "新客户数", "value": "NewUserNum", "selected": True, "index": 2},
                      {"value": "ANUV", "text": "新访客数-全部渠道", "selected": True, "index": 3},
                      {"value": "AOUV", "text": "老访客数-全部渠道", "selected": True, "index": 4},
