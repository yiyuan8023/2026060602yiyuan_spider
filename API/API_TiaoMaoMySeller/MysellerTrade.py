...
from API.API_TiaoMaoMySeller.MySellerBase import MySellerBaseAPI
...
class MySellerTradeAPI(MySellerBaseAPI):
    ...
    def taobao_order_discount_details(self, order_id):
        # 已卖出宝贝_订单详情_消费者视角优惠明细
        ...
        try:
            ...
            if req_log(res):
                ...
                # 提取消费者视角优惠明细（第一个PriceComposition中的dialog内容）
