...
from extra.WanXiangTaiApi.WanXiangTaiReport import WanXiangTaiReportApi

from extra.extra_excel import read_download_zip
...
if __name__ == '__main__':
    logger.info("*" * 100)
    logger.info("开始采集：tb_tg_万相台无界_基础报表_宝贝主体")
    db_obj = DB()
    cookies_ = db_obj.do_select_cookies("生意参谋")
    table_name = "tb_tg_万相台无界_基础报表_宝贝主体_202504"
    for i in cookies_:
        cookie = i[1]
        ...
        task_id=WanXiangTaiReportObj.main_report__main_data_details()
        sleep(60*3)
        # task_id = '10568864'
